...
angular.module('myApp.viewSystemResults', [])
	...
	.controller('ViewSystemResultsCtrl', function ($modal, $location, $scope, $route, $q, screamMenu, Analysis, Atck, ErrorMode, Stc, errorModes, threatModel) {
		...
		// First we check if this system has a description
		if (_.isUndefined($scope.sys.description)) {
			var modalInstance = $modal.open({
				animation: true,
				templateUrl: 'warningModalNoDesc',
				size: 'sg',
